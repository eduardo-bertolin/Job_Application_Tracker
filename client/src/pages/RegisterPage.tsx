  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-primary-600">
        ...
        {/* Decorative elements */}
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-primary-400 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob" />
        <div className="absolute top-1/3 left-12 w-72 h-72 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000" />
        <div className="absolute -top-8 right-20 w-80 h-80 bg-pink-400 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-4000" />
        ...
        <div className="relative z-10 w-full flex flex-col justify-center px-16 text-white">
          ...
          <h2 className="text-5xl font-extrabold leading-tight mb-6">
            Start your <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-purple-200">journey today.</span>
          </h2>
          <p className="text-lg text-primary-100 max-w-md leading-relaxed">
            Join thousands of professionals using AI-powered insights to organize applications and stand out to employers.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-16 relative">
        <div className="w-full max-w-md space-y-8 relative z-10">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-slate-500 text-sm">Join JobTracker and take control of your career.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="group relative w-full flex justify-center items-center gap-2 py-3 px-4 border border-transparent text-sm font-medium rounded-xl text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all shadow-md hover:shadow-lg disabled:opacity-70 disabled:cursor-not-allowed overflow-hidden mt-2"
            >
